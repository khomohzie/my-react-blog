...
import AOS from 'aos'
import Background from '../assets/images/blogpost.png'
                    ...
                    <div className="row mt-2">
                        ...
                        <div className="col-md-8">
                            <div className="card">
                                <div className="card-block">
                                    ...
                                    <p>
                                        <img src="img/image.jpg" className="img-fluid" alt="Responsive" />
                                    </p>
                        ...
                        <div className="col-md-4 d-none d-md-block mb-3">
                            <div className="card card-block">
                                <h5 className="card-header" style={{background: "var(--sky)", color: "var(--midnight)"}}>Recent Posts</h5>
                                ...
                                <div className="card-footer mt-1" style={{background: "var(--sky)", color: "var(--midnight)"}}>
                                    <a href="#">View More</a>
                                </div>
                            </div>
                            <div className="card card-block mt-3">
                                <h5 className="card-header" style={{background: "var(--sky)", color: "var(--midnight)"}}>Archives</h5>
                                <div className="list-group">
                                    <button type="button" className="list-group-item">Cras justo odio</button>
                            ...
                            <div className="card card-block mt-3">
                                <h5 className="card-header" style={{background: "var(--sky)", color: "var(--midnight)"}}>Categories</h5>
                                <div className="list-group">
                                    <button type="button" className="list-group-item">Cras justo odio</button>
                                    <button type="button" className="list-group-item">Dapibus ac facilisis in</button>
                                    <button type="button" className="list-group-item">Morbi leo risus</button>
